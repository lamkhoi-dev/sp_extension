          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400">
                {referredUsers.length} liên kết giới thiệu · Click để mở sơ đồ phóng to
              </p>
            </div>
          </div>
          <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline">Mở rộng sơ đồ →</span>
        </button>
      </div>

      {/* Full-screen Modal for Genealogy Tree */}
      <Modal
        isOpen={showTree}
