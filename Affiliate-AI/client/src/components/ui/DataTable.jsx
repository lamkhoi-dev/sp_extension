          ...
          {searchable && (
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          )}
          {onPageSizeChange && (
            <div className="flex items-center gap-2 self-end sm:self-auto">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (!serverSide) setCurrentPageState(1);
                }}
                className="py-1.5 px-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
